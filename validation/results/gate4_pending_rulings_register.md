...
- **R-QUOTA-PATH-AD** [OPEN] Quota recovery path authorization: Path A (uid quota raise) vs Path D (authorization-required scoped cleanup fallback, idealized spectra only)
  ...
  - constraint: no authority exists for ADDITIONAL deletions or quota changes; the executed Path D cleanup is recorded, not retroactively ruled; G2c job submission is governed by the G2c checkpoint's separately recorded durable authorization (2026-08-13) and its review gates; this row remains OPEN as a formal-intake/documentation gap pending Greg's canonical assignment
...
- `/shared/home/greg/Projects/AnalyticBandRadiation-platform/validation/results/gate4_g2c_eval2_fetch_checkpoint.json` sha256 `dd45f8da06e12476f068945b6eb07e80cca9a3f1a93ffc1ec1d6b3877240b367` (json)
...
- `/shared/home/greg/Projects/AnalyticBandRadiation-platform/validation/gate4_g2c_quota_recovery_runbook.md` sha256 `a234869b8466924443edb6a966eed5d4c19e3b076c53a698ff0dc240fcbe8eba` (md)
