...
## Contract verdicts (41 satisfied / 1 inactive / 0 selftest-state / 0 violated)
...
Provenance: branch `glw/gate4-recovery`, generated_from_head `dec274d` (pre-own-commit).
