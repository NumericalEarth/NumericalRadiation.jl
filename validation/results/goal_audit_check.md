...
|---|---|---|---|
| Plan reviewed and concrete three-step /goal captured | `satisfied` | The project plan and audit list the three concrete goal gates with current status. | ecRad convention gap report (`verified`)<br>ecRad hard-threshold accuracy gate (`verified`) |
