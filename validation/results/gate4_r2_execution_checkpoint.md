...
Status: **r2_execution_checkpoint_ready**

script generation only; nothing submitted by this unit; build+create_lut only; no objective, floor, acceptance, or promotion.
...
| v14_raw_output_absent | passed |
| v14_tree_at_pinned_commit | passed |

Generated (unsubmitted) batch script: `/shared/home/greg/Projects/AnalyticBandRadiation-platform/validation/results/gate4_r2_dryrun.sbatch`
