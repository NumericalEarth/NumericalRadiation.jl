...
module TestEcckdOfficialFilesCheck
using Test
using NumericalRadiation
using Dates

# --- begin content of test_ecckd_official_files_check.jl ---
using JSON
...
# --- end content of test_ecckd_official_files_check.jl ---

end # module TestEcckdOfficialFilesCheck
