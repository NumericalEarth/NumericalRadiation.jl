...
@testset "NumericalRadiation" begin
    ...
    include_slow_validation_test("test_reduced_ecckd_leave_one_out_refit_breakdown.jl")
    include_slow_validation_test("test_reduced_ecckd_leave_one_out_heating_table_optimizer.jl")
    include_slow_validation_test("test_reduced_ecckd_leave_one_out_single_table_move_scan.jl")
    include_slow_validation_test("test_reduced_ecckd_leave_one_out_weight_coordinate_scan.jl")
    include_slow_validation_test("test_reduced_ecckd_leave_one_out_weight_coordinate_descent.jl")
    include_slow_validation_test("test_reduced_ecckd_leave_one_out_weight_coordinate_descent_continuation.jl")
    include_slow_validation_test("test_reduced_ecckd_leave_one_out_weight_coordinate_boundary_polish.jl")
    include_slow_validation_test("test_reduced_ecckd_leave_one_out_heating_residual_localization.jl")
    ...
    include_slow_validation_test("test_ecckd_candidate_original_objective_score.jl")
    include_slow_validation_test("test_ecckd_candidate_transfer_smoke.jl")
    include_slow_validation_test("test_ecckd_candidate_transfer_optimizer_probe.jl")
    include_slow_validation_test("test_ecckd_candidate_table_parameter_probe.jl")
    include_slow_validation_test("test_ecckd_candidate_table_writeback_probe.jl")
    include_slow_validation_test("test_ecckd_candidate_table_writeback_continuation.jl")
    include_slow_validation_test("test_ecckd_candidate_table_writeback_multisample.jl")
    include_slow_validation_test("test_ecckd_candidate_table_multisample_optimizer.jl")
    include_slow_validation_test("test_ecckd_candidate_table_written_coordinate_scan.jl")
    include_slow_validation_test("test_ecckd_candidate_table_written_coordinate_descent.jl")
    include_slow_validation_test("test_ecckd_candidate_table_written_minimax_descent.jl")
    include_slow_validation_test("test_ecckd_candidate_table_humidity_split_probe.jl")
    include_slow_validation_test("test_ecckd_candidate_table_humidity_split_descent.jl")
    include_slow_validation_test("test_ecckd_candidate_table_humidity_tribin_probe.jl")
    include_slow_validation_test("test_ecckd_candidate_table_humidity_tribin_descent.jl")
    include_slow_validation_test("test_ecckd_candidate_table_humidity_tribin_weighted_descent.jl")
    include_slow_validation_test("test_ecckd_candidate_table_humidity_tribin_constrained_descent.jl")
    ...
    include_slow_validation_test("test_reduced_ecckd_subset_search.jl")
    include_slow_validation_test("test_reduced_ecckd_size_scan.jl")
    ...
    include_test("test_reduced_ecckd_gap_report.jl")
    ...
    include_slow_validation_test("test_reduced_ecckd_constrained_table_optimizer.jl")
